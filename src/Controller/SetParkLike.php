...
{
    #[Route('/api/setparklike', name: 'api_set_parklike', methods: ['POST'])]
    public function addUserParking(Request $request, EntityManagerInterface $entityManager): JsonResponse
    {
